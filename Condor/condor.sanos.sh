...
python /home/diana/breast_cancer_networks/parallel_aracne/genera_condor.py \
    ...
    --expfile /mnt/e/diana/TCGA_miRNA_BC/datos_nivel3_norm_TCGA/sanos.86.txt \
    --probes /mnt/e/diana/TCGA_miRNA_BC/datos_nivel3_norm_TCGA/GENEID.86.txt \
    --run_id RNAseq_86.sanos.rsem \
    --outdir /mnt/e/diana/TCGA_miRNA_BC/datos_nivel3_norm_TCGA/RNAseq_86.sanos.rsem \
    --p 1
...
# condor_submit RNAseq_86.sanos.rsem.condor
